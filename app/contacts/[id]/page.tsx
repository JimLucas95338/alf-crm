    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        ...
        <div className="text-right">
          ...
          <div className="mt-2 text-sm">
            {contact.phone ? <a href={`tel:${contact.phone}`}>{contact.phone}</a> : <span style={{ color: "var(--muted)" }}>no phone</span>}
          </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          <div className="panel p-4">
            <div className="font-medium mb-3">Contact details</div>
          ...
          <div className="panel">
            ...
            <div className="p-2">
              {contact.executives.length === 0 ? (
                <div className="p-3 text-sm" style={{ color: "var(--muted)" }}>None on file.</div>
              ) : contact.executives.map((e) => (
                <div key={e.id} className="p-3 border-b" style={{ borderColor: "var(--border)" }}>
